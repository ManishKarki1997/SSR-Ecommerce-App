              ...
              <div>
                ...
                >
                  <template v-slot="{ inputValue, togglePopover }">
                    <div class="flex items-center">
                      <button
                        class="p-2 bg-blue-700 border border-blue-200 rounded-l text-primary hover:bg-blue-800 focus:bg-blue-800 focus:border-blue-500 focus:outline-none"
                        @click="togglePopover()"
                      >
                        <svg
              ...
              <div>
                ...
                >
                  <template v-slot="{ inputValue, togglePopover }">
                    <div class="flex items-center">
                      <button
                        class="p-2 text-white bg-blue-700 border border-blue-200 rounded-l hover:bg-blue-800 focus:bg-blue-800 focus:border-blue-800 focus:outline-none"
                        @click="togglePopover()"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <input
                        :value="inputValue"
                        class="w-full px-2 py-1 text-gray-700 bg-white border rounded-r appearance-none focus:outline-none focus:border-blue-800"
                        readonly
                      />
                    </div>
                  </template>
